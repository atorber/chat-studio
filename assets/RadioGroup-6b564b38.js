import{d as j,h as z,L as ne,b$ as ae,c0 as O,O as ie,bI as G,q as $,b as de,t as P,bL as M,u as N,P as L,S as D,f as B,j as x,g as l,k as S,l as U,n as V,s as I,z as _,c1 as K,D as W,E as se,B as le,c2 as ce,c3 as ue}from"./index-60f5c441.js";const we=j({props:{onFocus:Function,onBlur:Function},setup(e){return()=>z("div",{style:"width: 0; height: 0",tabindex:0,onFocus:e.onFocus,onBlur:e.onBlur})}}),be=e=>{const{borderColor:o,primaryColor:t,baseColor:n,textColorDisabled:a,inputColorDisabled:f,textColor2:r,opacityDisabled:s,borderRadius:d,fontSizeSmall:v,fontSizeMedium:p,fontSizeLarge:C,heightSmall:b,heightMedium:R,heightLarge:m,lineHeight:w}=e;return Object.assign(Object.assign({},ae),{labelLineHeight:w,buttonHeightSmall:b,buttonHeightMedium:R,buttonHeightLarge:m,fontSizeSmall:v,fontSizeMedium:p,fontSizeLarge:C,boxShadow:`inset 0 0 0 1px ${o}`,boxShadowActive:`inset 0 0 0 1px ${t}`,boxShadowFocus:`inset 0 0 0 1px ${t}, 0 0 0 2px ${O(t,{alpha:.2})}`,boxShadowHover:`inset 0 0 0 1px ${t}`,boxShadowDisabled:`inset 0 0 0 1px ${o}`,color:n,colorDisabled:f,colorActive:"#0000",textColor:r,textColorDisabled:a,dotColorActive:t,dotColorDisabled:o,buttonBorderColor:o,buttonBorderColorActive:t,buttonBorderColorHover:o,buttonColor:n,buttonColorActive:n,buttonTextColor:r,buttonTextColorActive:t,buttonTextColorHover:t,opacityDisabled:s,buttonBoxShadowFocus:`inset 0 0 0 1px ${t}, 0 0 0 2px ${O(t,{alpha:.3})}`,buttonBoxShadowHover:"inset 0 0 0 1px #0000",buttonBoxShadow:"inset 0 0 0 1px #0000",buttonBorderRadius:d})},he={name:"Radio",common:ne,self:be},q=he,fe={name:String,value:{type:[String,Number,Boolean],default:"on"},checked:{type:Boolean,default:void 0},defaultChecked:Boolean,disabled:{type:Boolean,default:void 0},label:String,size:String,onUpdateChecked:[Function,Array],"onUpdate:checked":[Function,Array],checkedValue:{type:Boolean,default:void 0}},Y=ie("n-radio-group");function ve(e){const o=G(e,{mergedSize(i){const{size:c}=e;if(c!==void 0)return c;if(r){const{mergedSizeRef:{value:h}}=r;if(h!==void 0)return h}return i?i.mergedSize.value:"medium"},mergedDisabled(i){return!!(e.disabled||r!=null&&r.disabledRef.value||i!=null&&i.disabled.value)}}),{mergedSizeRef:t,mergedDisabledRef:n}=o,a=$(null),f=$(null),r=de(Y,null),s=$(e.defaultChecked),d=P(e,"checked"),v=M(d,s),p=N(()=>r?r.valueRef.value===e.value:v.value),C=N(()=>{const{name:i}=e;if(i!==void 0)return i;if(r)return r.nameRef.value}),b=$(!1);function R(){if(r){const{doUpdateValue:i}=r,{value:c}=e;D(i,c)}else{const{onUpdateChecked:i,"onUpdate:checked":c}=e,{nTriggerFormInput:h,nTriggerFormChange:u}=o;i&&D(i,!0),c&&D(c,!0),h(),u(),s.value=!0}}function m(){n.value||p.value||R()}function w(){m()}function k(){b.value=!1}function y(){b.value=!0}return{mergedClsPrefix:r?r.mergedClsPrefixRef:L(e).mergedClsPrefixRef,inputRef:a,labelRef:f,mergedName:C,mergedDisabled:n,uncontrolledChecked:s,renderSafeChecked:p,focus:b,mergedSize:t,handleRadioInputChange:w,handleRadioInputBlur:k,handleRadioInputFocus:y}}const ge=B("radio",`
