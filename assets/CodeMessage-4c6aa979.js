import{b as F,dJ as O,s as j,L as J,k as C,f as K,j as L,g as U,d as H,P as Z,q as N,o as A,w as _,t as M,n as S,D as G,h as z,a0 as W,a1 as o,a4 as Q,a5 as X,a6 as Y,a7 as g,aa as p,a8 as v,ab as ee,ac as ne,a9 as te,av as oe,a2 as le}from"./index-364c5099.js";function se(e,n){const l=F(O,null);return j(()=>e.hljs||(l==null?void 0:l.mergedHljsRef.value))}const ie=e=>{const{textColor2:n,fontSize:l,fontWeightStrong:s,textColor3:h}=e;return{textColor:n,fontSize:l,fontWeightStrong:s,"mono-3":"#a0a1a7","hue-1":"#0184bb","hue-2":"#4078f2","hue-3":"#a626a4","hue-4":"#50a14f","hue-5":"#e45649","hue-5-2":"#c91243","hue-6":"#986801","hue-6-2":"#c18401",lineNumberTextColor:h}},re={name:"Code",common:J,self:ie},ae=re,ce=C([K("code",`
 ...
 }`]}]),he=Object.assign(Object.assign({},S.props),{language:String,code:{type:String,default:""},trim:{type:Boolean,default:!0},hljs:Object,uri:Boolean,inline:Boolean,wordWrap:Boolean,showLineNumbers:Boolean,internalFontSize:Number,internalNoHighlight:Boolean}),ue=H({name:"Code",props:he,setup(e,{slots:n}){const{internalNoHighlight:l}=e,{mergedClsPrefixRef:s,inlineThemeDisabled:h}=Z(),r=N(null),d=l?{value:void 0}:se(e),$=(t,a,i)=>{const{value:c}=d;return!c||!(t&&c.getLanguage(t))?null:c.highlight(i?a.trim():a,{language:t}).value},w=j(()=>e.inline||e.wordWrap?!1:e.showLineNumbers),k=()=>{if(n.default)return;const{value:t}=r;if(!t)return;const{language:a}=e,i=e.uri?window.decodeURIComponent(e.code):e.code;if(a){const u=$(a,i,e.trim);if(u!==null){if(e.inline)t.innerHTML=u;else{const b=t.querySelector(".__code__");b&&t.removeChild(b);const f=document.createElement("pre");f.className="__code__",f.innerHTML=u,t.appendChild(f)}return}}if(e.inline){t.textContent=i;return}const c=t.querySelector(".__code__");if(c)c.textContent=i;else{const u=document.createElement("pre");u.className="__code__",u.textContent=i,t.innerHTML="",t.appendChild(u)}};A(k),_(M(e,"language"),k),_(M(e,"code"),k),l||_(d,k);const R=S("Code","-code",ce,ae,e,s),x=j(()=>{const{common:{cubicBezierEaseInOut:t,fontFamilyMono:a},self:{textColor:i,fontSize:c,fontWeightStrong:u,lineNumberTextColor:b,"mono-3":f,"hue-1":B,"hue-2":V,"hue-3":P,"hue-4":E,"hue-5":T,"hue-5-2":I,"hue-6":q,"hue-6-2":D}}=R.value,{internalFontSize:y}=e;return{"--n-font-size":y?`${y}px`:c,"--n-font-family":a,"--n-font-weight-strong":u,"--n-bezier":t,"--n-text-color":i,"--n-mono-3":f,"--n-hue-1":B,"--n-hue-2":V,"--n-hue-3":P,"--n-hue-4":E,"--n-hue-5":T,"--n-hue-5-2":I,"--n-hue-6":q,"--n-hue-6-2":D,"--n-line-number-text-color":b}}),m=h?G("code",j(()=>`${e.internalFontSize||"a"}`),x,e):void 0;return{mergedClsPrefix:s,codeRef:r,mergedShowLineNumbers:w,lineNumbers:j(()=>{let t=1;const a=[];let i=!1;for(const c of e.code)c===`
